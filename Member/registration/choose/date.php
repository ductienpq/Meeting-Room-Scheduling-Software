...
window.location.replace(\'http://localhost/PhpProject1/member.php?date=\'+ s +\' &room='.filter_input(INPUT_GET,'room').'&timestart='.filter_input(INPUT_GET,'timestart').'&duration='.filter_input(INPUT_GET,'duration').'\');
      }
</script>
<style>
#datepicker
